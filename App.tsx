...
function App() {
    ...
    useEffect(() => {
        ...
        // Check for redirect result on app load, this resolves the promise from signInWithRedirect
    ...
    const handleSignIn = async () => {
        ...
        setAuthError(null);
        // Use signInWithRedirect to avoid issues with browser popup blockers.
